...
from .models import (
    SafetyIncident, ComplianceChecklist, EnvironmentalMonitoring, ComplianceAssessment
)
...
# Commented out until Railway deployment is stable
...
class ComplianceAssessmentAdmin(admin.ModelAdmin):
    list_display = ['assessed_location', 'status', 'compliance_score', 'assessed_by', 'assessment_date']
    list_filter = ['status', 'assessed_by']
